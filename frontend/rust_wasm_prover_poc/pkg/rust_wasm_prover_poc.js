/* @ts-self-types="./rust_wasm_prover_poc.d.ts" */

/**
 * @param {string} inputs_json
 * @param {Uint8Array} pkey_bytes
 * @param {Uint8Array} graph_bytes
 * @param {Uint8Array} r1cs_bytes
 * @returns {string}
 */
export function prove_groth16_json(inputs_json, pkey_bytes, graph_bytes, r1cs_bytes) {
    let deferred6_0;
    let deferred6_1;
    try {
        const ptr0 = passStringToWasm0(inputs_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ptr1 = passArray8ToWasm0(pkey_bytes, wasm.__wbindgen_malloc);
        const len1 = WASM_VECTOR_LEN;
        const ptr2 = passArray8ToWasm0(graph_bytes, wasm.__wbindgen_malloc);
        const len2 = WASM_VECTOR_LEN;
        const ptr3 = passArray8ToWasm0(r1cs_bytes, wasm.__wbindgen_malloc);
        const len3 = WASM_VECTOR_LEN;
        const ret = wasm.prove_groth16_json(ptr0, len0, ptr1, len1, ptr2, len2, ptr3, len3);
        var ptr5 = ret[0];
        var len5 = ret[1];
        if (ret[3]) {
            ptr5 = 0; len5 = 0;
 ...
 * @param {string} verification_key_json
 * @returns {boolean}
 */
export function verify_groth16_json(proof_json, verification_key_json) {
    const ptr0 = passStringToWasm0(proof_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passStringToWasm0(verification_key_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len1 = WASM_VECTOR_LEN;
    const ret = wasm.verify_groth16_json(ptr0, len0, ptr1, len1);
    if (ret[2]) {
...
function __wbg_get_imports() {
    ...
    return {
        __proto__: null,
        "./rust_wasm_prover_poc_bg.js": import0,
    };
}
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('rust_wasm_prover_poc_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
