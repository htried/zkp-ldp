...
//     996452246304932491187838448288367965371837357284206925883546866701294631124n,
//     15569566348514570174809975754505749458934958707565733216930419792207728611n
//   ]
// Fingerprint 2 Hash as Felts: [
// 1568465034027929785865490850681301670064582328743610951506161259038211815489n,
// 929132963323219179650796614922269618698430854086935827675546144734293384929n
// ]
...
const test_cases = [
    ...
    {ips: ["3232235526","0","0","0","0"], 
        ...
        new_fingerprint: "15569566348514570174809975754505749458934958707565733216930419792207728611" }
];
...
async function sign_circom_inputs(unsigned_input) {
    ...
    const state_vec_string = unsigned_input.ips.concat(unsigned_input.geohashes).concat([unsigned_input.last_fingerprint, unsigned_input.users_prf_seed, unsigned_input.state_counter]);
...
async function run() {
    for (unsigned_input_obj of test_cases) {
        console.log("Unsigned input obj is: ", unsigned_input_obj);
