...
async function sign_circom_inputs(unsigned_input) {
    ...
    const response_vec_string = [unsigned_input.new_ip, unsigned_input.new_geohash, unsigned_input.new_rappor_nonce, unsigned_input.new_attribution_value, unsigned_input.new_fingerprint_nonce];
...
async function main() {
    ...
    const ks = [1, 5, 10, 25, 50, 100, 250, 500, 1000, 2500, 5000];
